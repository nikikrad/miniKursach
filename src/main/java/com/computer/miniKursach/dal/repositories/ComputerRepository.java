...
public class ComputerRepository implements IComputerRepository {
    public void create(ComputerEntity entity) throws SQLException {
        DBConnection.statement.executeUpdate(String.format("INSERT INTO computer ('ram', 'hdd', 'ssd', 'matherboard', 'power_unit', 'system_unit', 'video_card') VALUES ('%s', '%s') ", entity.ram, entity.hdd,entity.ssd,entity.matherboard,entity.power_unit,entity.power_unit,entity.video_card));
    }
